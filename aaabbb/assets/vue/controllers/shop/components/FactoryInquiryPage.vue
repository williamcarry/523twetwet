          ...
          <tbody>
            ...
            >
              ...
              <td class="product-cell">
                <div class="flex items-start product-cell-content">
                  <!-- 缩略图 -->
                  <div 
...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.product-cell-content > *:not(:last-child) {
  margin-right: 12px;
}
...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.attachments-list > *:not(:last-child) {
  margin-bottom: 12px;
}
...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.attachment-content > *:not(:last-child) {
  margin-right: 16px;
}
...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.attachment-details > *:not(:last-child) {
  margin-bottom: 12px;
}
...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.preview-image-wrapper > *:not(:last-child) {
  margin-bottom: 20px;
}
