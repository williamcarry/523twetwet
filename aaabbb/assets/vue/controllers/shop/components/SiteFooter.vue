<template>
  <footer class="bg-slate-900 text-slate-200 mt-[10px]">
    <div class="mx-auto max-w-[1500px] min-w-[1200px] w-[80%] py-10">
      <div class="grid grid-cols-2 md:grid-cols-4" style="gap: 2rem;">
        <div>
          ...
          <ul class="text-sm" style="margin: 0; padding: 0; list-style: none;">
            ...
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/membership">{{ t('membership') }}</a></li>
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/contact-us">{{ t('contactUs') }}</a></li>
          </ul>
        </div>
        <div>
          <h3 class="text-white font-semibold mb-3">{{ t('customerService') }}</h3>
          <ul class="text-sm" style="margin: 0; padding: 0; list-style: none;">
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/help-center">{{ t('helpCenter') }}</a></li>
            <!-- 售后条款 -->
            <li style="margin-bottom: 0.5rem;">
              <a 
            ...
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/shop/vat-policy">{{ t('vatPolicy') }}</a></li>
        ...
        <div>
          ...
          <ul class="text-sm" style="margin: 0; padding: 0; list-style: none;">
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/register">{{ t('crossBorderSeller') }}</a></li>
            <li style="margin-bottom: 0.5rem;"><a class="hover:text-primary" href="/supplier">{{ t('supplier') }}</a></li>
          </ul>
        </div>
        <div>
