...
/* 老浏览器（IE11、搜狗、360）兼容性修复：gap -> margin */
.hc-top-bar__right > *:not(:last-child) {
  margin-right: 12px;
}
...
.hc-header__inner {
  position: relative; display: flex; align-items: center; justify-content: space-between; padding: 24px 0; gap: 24px;
...
/* 搜索栏 - 在header内并排 */
.hc-search-wrapper {
  position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); display: flex; gap: 0;
