    ...
    <div class="mx-auto w-full max-w-[1500px] md:w-[80%] md:min-w-[1150px] px-4 md:px-0 py-6">
      ...
      <div class="bg-white shadow-sm mb-6">
        ...
        <div class="flex items-center px-5 py-2 border-b border-slate-200">
          ...
          <div class="flex-1 flex flex-wrap items-center selected-conditions">
            ...
            <template v-else>
              ...
              <span v-if="selectedCategory1" class="inline-flex items-center condition-tag text-xs bg-slate-100 px-2 py-1 rounded">{{ getCategory1Name(selectedCategory1) }} <button @click="selectedCategory1 = ''; selectedCategory2 = ''; selectedCategory3 = ''" class="text-slate-600 hover:text-primary font-bold tag-close">×</button></span>
              <span v-if="selectedCategory2" class="inline-flex items-center condition-tag text-xs bg-slate-100 px-2 py-1 rounded">{{ getCategory2Name(selectedCategory2) }} <button @click="selectedCategory2 = ''; selectedCategory3 = ''" class="text-slate-600 hover:text-primary font-bold tag-close">×</button></span>
              <span v-if="selectedCategory3" class="inline-flex items-center condition-tag text-xs bg-slate-100 px-2 py-1 rounded">{{ getCategory3Name(selectedCategory3) }} <button @click="selectedCategory3 = ''" class="text-slate-600 hover:text-primary font-bold tag-close">×</button></span>
            </template>
          </div>
        </div>
        ...
        <div class="flex items-center px-5 py-2 border-b border-slate-200">
          ...
          <div class="flex-1 flex flex-wrap items-center brand-list">
        ...
        <!-- 商品分类 -->
        <div class="flex items-center px-5 py-3 border-b border-slate-200 category-filter">
      ...
      <div class="bg-white shadow-sm mb-6">
        <div class="flex items-center px-5 py-3 border-b border-slate-200">
          ...
          <div class="flex-shrink-0">
            <ul class="flex items-center select-actions-list">
          ...
          <div class="flex-shrink-0">
            <ul class="flex items-center batch-actions-list">
              <li class="batch-action-item"><a href="javascript:;" class="text-xs text-slate-700 hover:text-primary transition inline-flex items-center action-link-item" :title="t('publish')">
                <img src="/frondend/images/AllProductsPage/publish_icon.png" :alt="t('publish')" class="w-4 h-4" />
                {{ t('publish') }}
              </a></li>
              <li class="batch-action-item"><a href="javascript:;" @click="batchDownloadProducts" :class="{'opacity-50 cursor-not-allowed': batchDownloading}" class="text-xs text-slate-700 hover:text-primary transition inline-flex items-center action-link-item">
              ...
              <li class="batch-action-item"><a href="javascript:;" @click="batchAddFavorites" class="text-xs text-slate-700 hover:text-red-600 transition inline-flex items-center action-link-item">
                <HeartIcon :size="16" fill="none" stroke="currentColor" :stroke-width="2" />
                {{ t('favorite') }}
              </a></li>
              <li class="batch-action-item"><a href="javascript:;" class="text-xs text-slate-700 hover:text-primary transition inline-flex items-center action-link-item">
        ...
        <div class="product-grid mb-8">
          ...
          >
            ...
            <div class="p-4">
              ...
              <!-- 区域选择器 -->
              <div class="mb-3 flex items-center justify-center flex-wrap region-selector" v-if="product.shippingRegions && product.shippingRegions.length > 0">
                <button
...
<style scoped>
/* 注意：复选框样式、批量操作按钮样式已移至全局 browser-compat.css */
