<template>
  <div class="bg-white rounded-b-lg border-x border-b border-slate-200 p-6">
    ...
    <!-- 账户类型选择 -->
    <form class="max-w-2xl basic-info-form">
      <div class="flex account-type-selector">
        <label class="flex items-center cursor-pointer radio-label">
      ...
      <div v-if="formData.accountType === 'personal'" class="border-t border-slate-200 pt-6">
        ...
        <div class="flex mb-6 form-row">
          ...
          <div class="flex-1 flex gender-options">
            <label class="flex items-center cursor-pointer radio-label">
      ...
      <div v-if="formData.accountType === 'enterprise'" class="border-t border-slate-200 pt-6">
        ...
        <div class="flex mb-6 form-row">
          ...
          <div class="flex-1 flex flex-wrap company-type-options">
            <label class="flex items-center cursor-pointer radio-label">
        ...
        <div class="flex mb-6 form-row">
          ...
          <div class="flex-1 flex capital-input-group">
            <input
...
/* 表单整体 - space-y-6 替代 */
.basic-info-form > *:not(:last-child) {
  margin-bottom: 1.5rem; /* 24px */
}

/* 账户类型选择器 - gap-4 替代 */
.account-type-selector > *:not(:last-child) {
...
/* 性别选项 - gap-4 替代 */
.gender-options > *:not(:last-child) {
  margin-right: 1rem; /* 16px */
}

/* 注册资本输入组 - gap-2 替代 */
.capital-input-group > *:not(:last-child) {
  margin-right: 0.5rem; /* 8px */
}

/* 公司类型选项 - gap-4 替代 */
.company-type-options > *:not(:last-child) {
  margin-right: 1rem; /* 16px */
}
