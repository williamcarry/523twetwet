...
.login-hero__stage {
  position: absolute;
  /* 使用传统的 top/right/bottom/left 代替 inset，兼容老旧浏览器 */
  top: 0;
  right: 0;
  bottom: 0;
  left: 0;
...
.login-hero__image {
  ...
  width: 100%;
  height: 100%;
  /* 使用 background-image 代替 object-fit，兼容老旧浏览器 */
